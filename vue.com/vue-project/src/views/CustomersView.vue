<template>
    <div>
        <DataTable :value="customers" :paginator="true" class="p-datatable-customers" :rows="10"
            ...
            <Column field="country.name" header="Country" sortable filterMatchMode="contains" style="min-width: 8rem">
                <template #body="{data}">
            ...
            <Column header="Agent" sortable filterField="representative" sortField="representative.name" :showFilterMatchModes="false" :filterMenuStyle="{'width':'14rem'}" style="min-width: 14rem">
                 <template #body="{data}">
                    <img v-bind:src="'https://www.primefaces.org/primevue/demo/images/avatar/' + data.representative.image" width="30" style="vertical-align: middle" />
                    <span class="image-text" style="margin-left: .5em">{{data.representative.name}}</span>
                </template>
                <template #filter="{filterModel}">
                    ...
                    <MultiSelect v-model="filterModel.value" :options="representatives" optionLabel="name" placeholder="Any" class="p-column-filter">
                        <template #option="slotProps">
                            <div class="p-multiselect-representative-option">
                                <img v-bind:src="'https://www.primefaces.org/primevue/demo/images/avatar/' + slotProps.option.image" width="30" style="vertical-align: middle" />
                                <span class="image-text" style="margin-left: .5em">{{slotProps.option.name}}</span>
                            </div>
                        </template>
                    </MultiSelect>
                </template>
...
export default {
    setup() {
        onMounted(() => {
            ...
            // const data = await customerService.value.getCustomersLarge()
